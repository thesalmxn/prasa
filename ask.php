...
<html>
    ...
    <body id="ask">
        ...
        <a href="index.php">
            <div id="log">
                <div id="i">A</div><div id="cir">A</div><div id="ntro">lumni interact</div>
            </div>
        </a>
        <ul id="nav-bar">
            ...
            <div id="sf">
                <center>
                    <div class="heading ask">
                        <h1 class="logo"><div id="i">A</div><div id="cir">A</div><div id="ntro">lumni interact</div></h1>
                        <p id="tag-line">Asking questions is the first way to begin change</p>
                    </div>
                    ...
                    <form action="<?php echo htmlspecialchars( $_SERVER["PHP_SELF"] ); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <select name="cat">
                            ...
                            <option value="JNTUA_College">JNTUA College</option>
        ...
        <div id="ask-ta">
            <h1>Thank You.<br>Answer is on the way, stay tuned</h1>
        </div>
